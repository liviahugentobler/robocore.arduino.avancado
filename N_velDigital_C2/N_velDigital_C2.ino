...
// define os caracteres especiais para formar um ponteiro no LCD
...
int coluna; // variavel para armazenar a posição da coluna do LCD


void setup()
{
  // configura o LCD com os numero de colunas e linhas
  lcd.begin (16,2); // 16 colunas e 2 linhas

  // cria os caracteres especiais na memoria do LCD
  ...
  lcd.print("Inclinometro"); // imprime mesagem 
  lcd.setCursor(5,1);
  lcd.print("Digital");

  delay(2000); // aguarda 2 segundos para iniciar
...
void loop()
{
  ...
  Wire.endTransmission(false); // encerra transmição
